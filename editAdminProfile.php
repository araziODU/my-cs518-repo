...
<html>
	...
	<body>
         ...
         <tr>
		  ...
		  <tr>
		   <td width="400">&nbsp;</td>
		   <td align='center'><input name="btnFinish" type="submit" id="btnFinish" value="Finish"><a href="adminProfile.php"><input name="returnBtn" type="button" id="returnBtn" value="Cancel"></a></td>
		  </tr>
		 </table>
		</form>
        </div>
