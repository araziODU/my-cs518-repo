...
where rowNum =1 and id >500 and id <=1000"; // run this twice starting from last index ran to increment this as it times out
...
if($rows>0)
            ...
            echo "success 3/4";
                        ...
                        where rowNum =1 and id > 0 and id <=500"; // run this twice starting from last index ran to increment this as it times out
                        $result = $connection->query($sql);
                        $rows=mysqli_num_rows($result);
